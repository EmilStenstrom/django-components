...
class StartComponentTestCase(TestCase):
    ...
    def test_create_component(self):
        ...
        component_path = os.path.join(
            self.tmp_dir, "components", component_name
        )
        self.assertTrue(os.path.exists(component_path))
        self.assertTrue(
            os.path.exists(os.path.join(component_path, "script.js"))
        )
        self.assertTrue(
            os.path.exists(os.path.join(component_path, "style.css"))
        )
        self.assertTrue(
            os.path.exists(os.path.join(component_path, "template.html"))
        )
        self.assertTrue(
            os.path.exists(
    ...
    def test_create_component_with_custom_filenames(self):
        ...
        self.assertTrue(os.path.exists(component_path))
        self.assertTrue(
            os.path.exists(os.path.join(component_path, js_filename))
        )
        self.assertTrue(
            os.path.exists(os.path.join(component_path, css_filename))
        )
        self.assertTrue(
            os.path.exists(os.path.join(component_path, template_filename))
        )
        self.assertTrue(
            os.path.exists(
                os.path.join(component_path, f"{component_name}.py")
    ...
    def test_create_component_with_existing_directory_and_force(self):
        ...
        call_command(
            "startcomponent", component_name, path=self.tmp_dir, force=True
        )
