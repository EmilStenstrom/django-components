...
class MainMediaTest(BaseTestCase):
    def test_html_js_css_inlined(self):
        ...
        self.assertInHTML(
            '<div class="html-css-only" data-djc-id-a1bc3e data-djc-scope-392a86>Content</div>',
            rendered,
        )
        self.assertInHTML(
    ...
    def test_html_js_css_filepath_rel_to_component(self):
        ...
        self.assertInHTML(
            """
            <form data-djc-id-a1bc41 data-djc-scope-1a4ce8 method="post">
    ...
    def test_html_js_css_filepath_from_static(self):
        ...
        self.assertIn(
            "Variable: <strong data-djc-id-a1bc41 data-djc-scope-4a2cb7>test</strong>",
            rendered,
        )
        self.assertInHTML(
